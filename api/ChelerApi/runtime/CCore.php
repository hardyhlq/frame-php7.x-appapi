...
class CCore {
	 ...
	 * 获取缓存对象
	 * 全局使用方法：$this->Redis()
	 * @return \ChelerApi\cache\CRedis
	 */
	public function Redis() {
		if (!isset(self::$instance['_redis_'])) {
			$r = $this->load('\ChelerApi\cache\CRedis');
			$r->initClient(ChelerApi::getConfig('redis'));
			self::$instance['_redis_'] = $r;
		}
		return self::$instance['_redis_'];
	}
